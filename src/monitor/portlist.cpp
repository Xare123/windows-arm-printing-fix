...
#include "evp_stub.h"	/* ARM64: OpenSSL replaced by no-op stub (run-as-user password unused) */
	...
	case 2:
		{
			...
			pPortInfo->fPortType = PORT_TYPE_WRITE;	/* ARM64 spooler requires this to bind a printer to the port */
